...
import  AbsoluteDefaultResolver , { BigIntResolver as BigIntNamedWithAliasResolver,BigIntResolver as BigIntSameNamedWithAliasResolver,DateTimeResolver,DateTimeNamedResolver,DateTimeSameNamedImportResolver } from 'graphql-scalars';
import  RelativeDefaultResolver   from './scalars/DefaultScalar';
import    { NamedImportResolver,NamedImportResolver as NamedImportWithAliasResolver } from './scalars/Scalars';
import    { UserPayload as UserPayloadResolver } from './otherResolvers.js';
import    { ErrorType } from './base/CustomErrorType';
    export const resolvers: Resolvers = {
      Query: { topicById: Query_topicById,topicsCreatedByUser: Query_topicsCreatedByUser,userByAccountName: Query_userByAccountName,me: meResolver },
