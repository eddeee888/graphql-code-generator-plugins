import type   { ProfileMetaResolvers } from './../../types.generated';
    ...
    /* Implement ProfileMeta resolver logic here */
        isCompleted: async (_parent, _arg, _ctx) => { /* ProfileMeta.isCompleted resolver is required because ProfileMeta.isCompleted exists but ProfileMetaMapper.isCompleted does not */ },
