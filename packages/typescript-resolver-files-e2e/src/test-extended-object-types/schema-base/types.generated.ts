...
export type Cat = Pet & {
  __typename?: 'Cat';
  canMeow: Scalars['Boolean']['output'];
  id: Scalars['ID']['output'];
  owner?: Maybe<User>;
};
...
export type Dog = Pet & {
  __typename?: 'Dog';
  canBark: Scalars['Boolean']['output'];
  id: Scalars['ID']['output'];
};
...
export type Genre = Comedy | Fantasy;
...
export type TopicsCreatedByUserPayload = PayloadError | TopicsCreatedByUserResult;
...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  Genre:
    | ( Comedy & { __typename: 'Comedy' } )
    | ( Fantasy & { __typename: 'Fantasy' } )
  ;
  TopicByIdPayload:
    | ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } )
    | ( Omit<TopicByIdResult, 'result'> & { result?: Maybe<_RefType['Topic']> } & { __typename: 'TopicByIdResult' } )
  ;
  TopicCreatePayload:
    | ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } )
    | ( Omit<TopicCreateResult, 'result'> & { result: _RefType['Topic'] } & { __typename: 'TopicCreateResult' } )
  ;
  TopicEditPayload:
    | ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } )
    | ( Omit<TopicEditResult, 'result'> & { result: _RefType['Topic'] } & { __typename: 'TopicEditResult' } )
  ;
  TopicsCreatedByUserPayload:
    | ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } )
    | ( Omit<TopicsCreatedByUserResult, 'result'> & { result: Array<_RefType['Topic']> } & { __typename: 'TopicsCreatedByUserResult' } )
  ;
  UserPayload:
    | ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } )
...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  Error: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } );
  Pet:
    | ( Cat & { __typename: 'Cat' } )
    | ( Dog & { __typename: 'Dog' } )
  ;
...
export type ResolversTypes = {
  ...
  Comedy: ResolverTypeWrapper<Comedy>;
  ...
  Fantasy: ResolverTypeWrapper<Fantasy>;
  Genre: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['Genre']>;
  Mutation: ResolverTypeWrapper<Record<PropertyKey, never>>;
  PaginationInput: PaginationInput;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  PaginationResult: ResolverTypeWrapper<PaginationResult>;
  PayloadError: ResolverTypeWrapper<Omit<PayloadError, 'error'> & { error: ResolversTypes['ErrorType'] }>;
  ...
  TopicByIdPayload: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['TopicByIdPayload']>;
  TopicByIdResult: ResolverTypeWrapper<Omit<TopicByIdResult, 'result'> & { result?: Maybe<ResolversTypes['Topic']> }>;
  TopicCreateInput: TopicCreateInput;
  TopicCreatePayload: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['TopicCreatePayload']>;
  TopicCreateResult: ResolverTypeWrapper<Omit<TopicCreateResult, 'result'> & { result: ResolversTypes['Topic'] }>;
  TopicEditInput: TopicEditInput;
  TopicEditPayload: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['TopicEditPayload']>;
  TopicEditResult: ResolverTypeWrapper<Omit<TopicEditResult, 'result'> & { result: ResolversTypes['Topic'] }>;
  TopicsCreatedByUserInput: TopicsCreatedByUserInput;
  TopicsCreatedByUserPayload: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['TopicsCreatedByUserPayload']>;
  TopicsCreatedByUserResult: ResolverTypeWrapper<Omit<TopicsCreatedByUserResult, 'result'> & { result: Array<ResolversTypes['Topic']> }>;
...
export type ResolversParentTypes = {
  ...
  Fantasy: Fantasy;
  Genre: ResolversUnionTypes<ResolversParentTypes>['Genre'];
  ...
  TopicByIdResult: Omit<TopicByIdResult, 'result'> & { result?: Maybe<ResolversParentTypes['Topic']> };
  TopicCreateInput: TopicCreateInput;
  TopicCreatePayload: ResolversUnionTypes<ResolversParentTypes>['TopicCreatePayload'];
  TopicCreateResult: Omit<TopicCreateResult, 'result'> & { result: ResolversParentTypes['Topic'] };
  TopicEditInput: TopicEditInput;
  TopicEditPayload: ResolversUnionTypes<ResolversParentTypes>['TopicEditPayload'];
  TopicEditResult: Omit<TopicEditResult, 'result'> & { result: ResolversParentTypes['Topic'] };
  TopicsCreatedByUserInput: TopicsCreatedByUserInput;
  TopicsCreatedByUserPayload: ResolversUnionTypes<ResolversParentTypes>['TopicsCreatedByUserPayload'];
  TopicsCreatedByUserResult: Omit<TopicsCreatedByUserResult, 'result'> & { result: Array<ResolversParentTypes['Topic']> };
  User: User;
  UserPayload: ResolversUnionTypes<ResolversParentTypes>['UserPayload'];
  UserResult: UserResult;
};

export type BookStore_NewResolvers<ContextType = any, ParentType extends ResolversParentTypes['BookStore_New'] = ResolversParentTypes['BookStore_New']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};

export type CatResolvers<ContextType = any, ParentType extends ResolversParentTypes['Cat'] = ResolversParentTypes['Cat']> = {
  canMeow?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  owner?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ComedyResolvers<ContextType = any, ParentType extends ResolversParentTypes['Comedy'] = ResolversParentTypes['Comedy']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DogResolvers<ContextType = any, ParentType extends ResolversParentTypes['Dog'] = ResolversParentTypes['Dog']> = {
  canBark?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ErrorTypeResolvers = EnumResolverSignature<{ FORBIDDEN_ERROR?: any, INPUT_VALIDATION_ERROR?: any, NOT_FOUND?: any, UNEXPECTED_ERROR?: any }, ResolversTypes['ErrorType']>;

export type FantasyResolvers<ContextType = any, ParentType extends ResolversParentTypes['Fantasy'] = ResolversParentTypes['Fantasy']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type GenreResolvers<ContextType = any, ParentType extends ResolversParentTypes['Genre'] = ResolversParentTypes['Genre']> = {
  __resolveType?: TypeResolveFn<'Comedy' | 'Fantasy', ParentType, ContextType>;
};
...
export type PayloadErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['PayloadError'] = ResolversParentTypes['PayloadError']> = {
...
export interface SomeRandomScalarScalarConfig extends GraphQLScalarTypeConfig<ResolversTypes['SomeRandomScalar'], any> {
  name: 'SomeRandomScalar';
}

export type SubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = {
  profileChanges?: SubscriptionResolver<ResolversTypes['Profile'], "profileChanges", ParentType, ContextType>;
};

export type TopicResolvers<ContextType = any, ParentType extends ResolversParentTypes['Topic'] = ResolversParentTypes['Topic']> = {
  bookStore_for_topic?: Resolver<Maybe<ResolversTypes['BookStore_New']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndDifferentModule1?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndDifferentModule2?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndDifferentModule3?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndSameModule1?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndSameModule2?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
  extendedTopicFieldInDifferentFileAndSameModule3?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
  extendedTopicFieldInTheSameFileAndSameModule1?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  extendedTopicFieldInTheSameFileAndSameModule2?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  extendedTopicFieldInTheSameFileAndSameModule3?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  url?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type TopicByIdPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicByIdPayload'] = ResolversParentTypes['TopicByIdPayload']> = {
  __resolveType?: TypeResolveFn<'PayloadError' | 'TopicByIdResult', ParentType, ContextType>;
};

export type TopicByIdResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicByIdResult'] = ResolversParentTypes['TopicByIdResult']> = {
  result?: Resolver<Maybe<ResolversTypes['Topic']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TopicCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicCreatePayload'] = ResolversParentTypes['TopicCreatePayload']> = {
  __resolveType?: TypeResolveFn<'PayloadError' | 'TopicCreateResult', ParentType, ContextType>;
};

export type TopicCreateResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicCreateResult'] = ResolversParentTypes['TopicCreateResult']> = {
  result?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TopicEditPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicEditPayload'] = ResolversParentTypes['TopicEditPayload']> = {
  __resolveType?: TypeResolveFn<'PayloadError' | 'TopicEditResult', ParentType, ContextType>;
};

export type TopicEditResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicEditResult'] = ResolversParentTypes['TopicEditResult']> = {
  result?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TopicsCreatedByUserPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicsCreatedByUserPayload'] = ResolversParentTypes['TopicsCreatedByUserPayload']> = {
  __resolveType?: TypeResolveFn<'PayloadError' | 'TopicsCreatedByUserResult', ParentType, ContextType>;
};

export type TopicsCreatedByUserResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicsCreatedByUserResult'] = ResolversParentTypes['TopicsCreatedByUserResult']> = {
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
  ...
  bookStore_4_user?: Resolver<Maybe<ResolversTypes['BookStore_New']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type Resolvers<ContextType = any> = {
  ...
  Comedy?: ComedyResolvers<ContextType>;
  DateTime?: GraphQLScalarType;
  Dog?: DogResolvers<ContextType>;
  Error?: ErrorResolvers<ContextType>;
  ErrorType?: ErrorTypeResolvers;
  Fantasy?: FantasyResolvers<ContextType>;
