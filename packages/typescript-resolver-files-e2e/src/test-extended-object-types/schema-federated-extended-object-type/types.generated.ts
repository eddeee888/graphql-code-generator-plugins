...
export type FederationReferenceTypes = {
  ForeignType:
    ( { __typename: 'ForeignType' }
    & GraphQLRecursivePick<FederationTypes['ForeignType'], {"id":true}> );
};
...
export type ResolversTypes = {
  ...
  ForeignType: ResolverTypeWrapper<Omit<ForeignType, 'topics'> & { topics: Array<ResolversTypes['Topic']> }>;
...
export type ResolversParentTypes = {
  ...
  ForeignType: Omit<ForeignType, 'topics'> & { topics: Array<ResolversParentTypes['Topic']> } | FederationReferenceTypes['ForeignType'];
  ID: Scalars['ID']['output'];
...
export type ForeignTypeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ForeignType'] = ResolversParentTypes['ForeignType'], FederationReferenceType extends FederationReferenceTypes['ForeignType'] = FederationReferenceTypes['ForeignType']> = {
  __resolveReference?: ReferenceResolver<Maybe<ResolversTypes['ForeignType']> | FederationReferenceType, FederationReferenceType, ContextType>;
