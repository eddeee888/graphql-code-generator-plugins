...
export type Scalars = {
  ...
  Boolean: { input: true | false; output: true | false; }
  Int: { input: number; output: number; }
  Float: { input: number; output: number; }
  DateTime: { input: any; output: any; }
  SomeRandomScalar: { input: bigint; output: bigint; }
};
...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  TopicByIdPayload: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } ) | ( Omit<TopicByIdResult, 'result'> & { result?: Maybe<_RefType['Topic']> } & { __typename: 'TopicByIdResult' } );
  TopicCreatePayload: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } ) | ( Omit<TopicCreateResult, 'result'> & { result: _RefType['Topic'] } & { __typename: 'TopicCreateResult' } );
  TopicEditPayload: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } ) | ( Omit<TopicEditResult, 'result'> & { result: _RefType['Topic'] } & { __typename: 'TopicEditResult' } );
  TopicsCreatedByUserPayload: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } ) | ( Omit<TopicsCreatedByUserResult, 'result'> & { result: Array<_RefType['Topic']> } & { __typename: 'TopicsCreatedByUserResult' } );
  UserPayload: ( Omit<PayloadError, 'error'> & { error: _RefType['ErrorType'] } & { __typename: 'PayloadError' } ) | ( UserResult & { __typename: 'UserResult' } );
};
