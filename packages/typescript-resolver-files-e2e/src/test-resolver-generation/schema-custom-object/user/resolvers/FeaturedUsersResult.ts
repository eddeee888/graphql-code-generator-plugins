...
export const FeaturedUsersResult: FeaturedUsersResultResolvers = {
    ...
    names: async (_parent, _arg, _ctx) => { /* FeaturedUsersResult.names resolver is required because FeaturedUsersResult.names exists but FeaturedUsersResultMapper.names does not */ }
};