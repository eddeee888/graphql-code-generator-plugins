...
export const typeDefs = {
  ...
  definitions: [
      ...
      fields: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'PetResult' },
            },
          },
          directives: [],
        },
    ...
    {
      kind: 'ObjectTypeDefinition',
      name: { kind: 'Name', value: 'PetHousing' },
      interfaces: [],
      directives: [],
      fields: [
        {
    ...
    },
    {
      ...
      directives: [],
      types: [
        { kind: 'NamedType', name: { kind: 'Name', value: 'PetOk' } },
        { kind: 'NamedType', name: { kind: 'Name', value: 'PetError' } },
      ],
    },
    {
      kind: 'ScalarTypeDefinition',
