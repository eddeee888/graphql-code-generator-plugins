...
import { CountryMapper, ErrorTypeMapper, SortOrderMapper } from './base/base.mappers';
...
export type ResolversTypes = {
  ...
  CustomLogicScalar: ResolverTypeWrapper<Scalars['CustomLogicScalar']['output']>;
...
export type CountryResolvers = EnumResolverSignature<{ AU?: any, NZ?: any, US?: any }, ResolversTypes['Country']>;

export interface CustomLogicScalarScalarConfig extends GraphQLScalarTypeConfig<ResolversTypes['CustomLogicScalar'], any> {
...
export type PetHouseResolvers<ContextType = any, ParentType extends ResolversParentTypes['PetHouse'] = ResolversParentTypes['PetHouse']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};

export type PetToyResolvers<ContextType = any, ParentType extends ResolversParentTypes['PetToy'] = ResolversParentTypes['PetToy']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type SortOrderResolvers = EnumResolverSignature<{ ASC?: any, DESC?: any }, ResolversTypes['SortOrder']>;
...
export type ZooResolvers<ContextType = any, ParentType extends ResolversParentTypes['Zoo'] = ResolversParentTypes['Zoo']> = {
