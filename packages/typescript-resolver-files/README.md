...
| `fixObjectTypeResolvers`    | `boolean`                                                                                                                        | (Default: `true`) (Experimental) Statically compares object type's mapper types' field against schema types' fields, creating resolvers if required                                                                                                                          |
